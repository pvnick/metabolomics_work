...
curl 'http://pubchem.ncbi.nlm.nih.gov/summary/summary.cgi?cid='$PUBCHEM_ID'&disopt=DisplaySDF' > $SDF_2D_MOLECULE_PATH 2>/dev/null
curl 'http://pubchem.ncbi.nlm.nih.gov/summary/summary.cgi?cid='$PUBCHEM_ID'&disopt=3DDisplaySDF' > $SDF_3D_MOLECULE_PATH 2>/dev/null
