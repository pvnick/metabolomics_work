...
class Disambiguator:
    ...
    mlrPropCombo = ['CHEMSPIDER_OFRULEOF5VIOLATIONS', 'CHEMSPIDER_ACDKOCPH55', 'CHEMSPIDER_POLARSURFACEAREA', 'CHEMSPIDER_MOLARREFRACTIVITY', 'CHEMSPIDER_POLARIZABILITY']
    ...
    def disambiguate(self):
        ...
        if self.tryMLR():
            ...
            if filteredConfidentCandidateCount < 20:
                return 0
            yPred = self.makePredictionVector()
